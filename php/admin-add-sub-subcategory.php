...
$c->query("INSERT INTO sub_subcategories (kind_id, subcategory_id, name, unit_price, technical_price) VALUES (" . $kindID . ", " . $subcategoryID . ", '" . $name . "', " . $unitPrice . ", " . $technicalPrice . ")");
session_id("bengkel");
session_start();
