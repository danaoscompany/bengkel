...
$c->query("UPDATE users SET name='" . $name . "', account_type=" . $accountType . ", version=" . $version . ", minimum_payment=" . $minimumPayment . ", username='" . $username . "', profile_picture='profile_pictures/" . $_FILES["file"]["name"] . "', email='" . $email . "' WHERE uid='" . $uid . "'");
