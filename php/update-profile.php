...
$c->query("UPDATE users SET name='" . $name . "', account_type=" . $accountType . ", version=" . $version . ", username='" . $username . "', profile_picture='profile_pictures/" . $_FILES["file"]["name"] . "', email='" . $email . "' WHERE uid='" . $uid . "', profile_set_up=1 WHERE uid='" . $uid . "'");
