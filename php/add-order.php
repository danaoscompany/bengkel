...
$sql = "INSERT INTO orders (order_id, order_type, name, phone, kind, type, capacity, latitude, longitude, price_estimation, technical_estimation, date, progress, price_change_approval, end_result_approval, payment_method, done) VALUES ('" . $orderID . "', " . $orderType . ", '" . $name . "', '" . $phone . "', " . $kind . ", " . $type . ", " . $capacity . ", " . $latitude . ", " . $longitude . ", " . $priceEstimation . ", " . $technicalEstimation . ", '" . $date . "', " . $progress . ", " . $priceChangeApproval . ", " . $endResultApproval . ", " . $paymentMethod . ", 0)";
